    ...
    <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
        ...
        <?php foreach ($tplVars['list'] as $value) { ?>
            <tr>
                ...
                <td class="center">
                    <a href="<?php echo site_url('host/show/'.$value['id'])?>">详情</a>&nbsp;
                    <a href="<?php echo site_url('host/edit/'.$value['id'])?>">编辑</a>&nbsp;
                    <a href="<?php echo site_url('host/del/'.$value['id'])?>" onclick="javascript:return delConfirm()">删除</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
